...
game_window = Window(1280, 720, "Кнопка судного дня") 
...
class button(pyglet.sprite.Sprite):
    def __init__(self, img_file = "button2.png", x = 300, y = game_window.height - 140, batch = batch):
        img = pyglet.image.load(img_file)
        img.anchor_x = img.width // 2
        img.anchor_y = img.height // 2                        
        super(button, self).__init__(img, x = x, y = y, batch = batch) 

    def on_press(self, img_file = "button_pressed.png", x = 300, y = game_window.height - 159, batch = batch):
        global pressed
        img = pyglet.image.load(img_file)
        img.anchor_x = img.width // 2
        img.anchor_y = img.height // 2                         
    ...
    def reset(self, img_file = "button2.png", x = 300, y = game_window.height - 140, batch = batch):
        global pressed, bt
        img = pyglet.image.load(img_file)
        img.anchor_x = img.width // 2
        img.anchor_y = img.height // 2                        
...
class arrow(pyglet.sprite.Sprite):
    def __init__(self, img_file = "arrow.png", x = game_window.width - 250, y = game_window.height - 300, batch = batch):
        img = pyglet.image.load(img_file)
        img.anchor_x = img.width // 2
        img.anchor_y = 14                        
...
class hour_hand(pyglet.sprite.Sprite):
    def __init__(self, img_file = "hour_hand.png", x = game_window.width - 250, y = game_window.height - 300, batch = batch):
        img = pyglet.image.load(img_file)
        img.anchor_x = img.width // 2
        img.anchor_y = 14                        
...
class clock(pyglet.sprite.Sprite):
    def __init__(self, img_file = "clock.png", x = game_window.width - 250, y = game_window.height - 300, batch = batch):
        img = pyglet.image.load(img_file)
        img.anchor_x = img.width // 2
        img.anchor_y = img.height // 2                  
